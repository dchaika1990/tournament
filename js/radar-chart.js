$(document).ready(function () {
    ...
    var data = [
        {
            className: 'player-skills', // optional, can be used for styling
            axes: [
                {axis: "ATTACKING", value: 97},
                {axis: "CREATIVITY", value: 68},
                {axis: "DEFENDING", value: 28},
                {axis: "TACTICAL", value: 67},
                {axis: "TECHNICAL", value: 71},
            ]
        },
        {
            className: 'team-skills',
            axes: [
                {axis: "ATTACKING", value: 70},
                {axis: "CREATIVITY", value: 52},
                {axis: "DEFENDING", value: 53},
                {axis: "TACTICAL", value: 45},
                {axis: "TECHNICAL", value: 30}
            ]
        }
    ];
